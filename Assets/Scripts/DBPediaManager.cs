...
public class DBPediaManager : MonoBehaviour
{
    ...
    public void Initialize(){
        ...
        myPredicates = GetPredicates("Vka");
    }
    ...
    public List<predicate> GetPredicates(string path){
        TripleStore store = new TripleStore();
        List<predicate> predicates = new List<predicate>();
		//Create a Parameterized String
		//SparqlParameterizedString queryString = new SparqlParameterizedString();

        //InMemoryDataset ds = new InMemoryDataset(store, new Uri(testURI));
        ...
        //store.AddFromUri((Uri)testDataset);
        Debug.Log("Created store from uri");
 ...
 //   PREFIX mo: <http://purl.org/ontology/mo/>
         ...
         */
        queryString.CommandText = "SELECT DISTINCT ?property ?value WHERE {<http://dbpedia.org/resource/Barack_Obama> ?property ?value . filter ( ?property in ( rdf:type) ) } LIMIT 5";
    ...
    public void MaTestin()
	{
        ...
        SparqlRemoteEndpoint endpoint = new SparqlRemoteEndpoint(new Uri("http://demo.openlinksw.com/sparql"), "http://dig.csail.mit.edu/2008/webdav/timbl/foaf.rdf");
